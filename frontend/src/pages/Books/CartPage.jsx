...
<div className="flex mt-12 h-full flex-col overflow-hidden shadow-2xl bg-white rounded">
      ...
      <div className="flex items-start justify-between">
        ...
        <div className="ml-3 flex h-7 items-center ">
          <button
            ...
            type="button"
            className="relative -m-2 py-1 px-2 bg-red-400 text-white rounded-md hover:bg-red-600 transition-all duration-200"
          >
